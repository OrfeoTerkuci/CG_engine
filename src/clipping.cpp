...
void
clipTriangleTwoOutNear(Vector3D &a, Vector3D &b, Vector3D &c, int &indA, double &dVal,
...
void
clipTriangleTwoOutFar(Vector3D &a, Vector3D &b, Vector3D &c, int &indA, double &dVal,
                      std::vector<Vector3D> &newPoints, std::vector<face> &newFaces) {
    // a in, b and c out
    // Get new point in AB line
    double p = (dVal - b.z) / (a.z - b.z);
...
void
clipTriangleTwoOutLeft(Vector3D &a, Vector3D &b, Vector3D &c, int &indA, double &dVal,
...
void
clipTriangleTwoOutTop(Vector3D &a, Vector3D &b, Vector3D &c, int &indA, double &dVal,
                      double &dNear, std::vector<Vector3D> &newPoints,
                      std::vector<face> &newFaces) {
    Vector3D d;
    Vector3D e;
...
void
clipTop(figure *&originalFigure, std::vector<face> &newFaces, double &top, double &dNear) {
    double dVal;
    double yA;
    double yB;
    double yC;
